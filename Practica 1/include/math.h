...
double Angle(double x1, double y1, double x2, double y2); //Implementar el arcotangente
double Distance(double x1, double y1, double x2, double y2); //Usa teorema de pitágoras
bool ValueInRange(double value, double min, double max);
bool PointInRect(double x, double y, double rectx, double recty, double width, double height); //Para saber si un punto está dentro del parámetro
void ClosestPointToRect(double x, double y, double rectx, double recty, double width, double height, double* outx, double* outy);
bool RectsOverlap(double x1, double y1, double width1, double height1, double x2, double y2, double width2, double height2); //Dos rectángulos y dice si se solapan o no

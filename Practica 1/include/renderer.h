...
public:
    ...
    virtual void DrawLine(double x1, double y1, double x2, double y2) const; //Pinta una línea
    virtual void DrawRect(double x, double y, double width, double height) const; //Pinta un rectángulo

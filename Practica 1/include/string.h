...
public:
    ...
    String StripExt() const; //nombre de archivo sin extension
    String StripDir() const; //cambia la ruta en formato Windows y la elimina
    String ExtractExt() const; //lo contrario a StripExt
    String ExtractDir() const; //lo contrario a StripDir

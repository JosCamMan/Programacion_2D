...
int main(int argc, char* argv[]) {
	...
	while ( Screen::Instance().IsOpened() != Screen::Instance().KeyPressed(GLFW_KEY_ESC)) {
		...
		String dis = String::FromInt(Distance((Screen::Instance().GetWidth() / 2), (Screen::Instance().GetHeight() / 2), Screen::Instance().GetMouseX(), 
												Screen::Instance().GetMouseY()));
		String anguloTexto = String::FromInt(Angle(Screen::Instance().GetMouseX(), Screen::Instance().GetMouseY(), x, y));
